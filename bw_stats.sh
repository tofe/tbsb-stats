...
echo "Time, maxThreads, CurrentThreadCount, CurrentThreadsBusy" >> $BWHOSTNAME"_ThreadPool.csv"
./awks.sh  GetThreadPool.csv.tmp $BWHOSTNAME"_ThreadPool.csv"
